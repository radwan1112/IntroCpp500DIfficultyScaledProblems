...
int main()
{
    ...
    float avg_grade{};
    avg_grade = ((std1 >= 5 && std1 <= 10) * (std1) + (std2 >= 5 && std2 <= 10) * (std2) + (std3 >= 5 && std3 <= 10) * (std3)) / static_cast<float>(no_std_passed);
    std::cout << "The average grade of students who passed is: " << avg_grade << '\n';
